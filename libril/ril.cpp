...
static void dispatchIntsAllowData (Parcel& p, RequestInfo *pRI);
...
static void
dispatchIntsAllowData (Parcel &p, RequestInfo *pRI) {
    int32_t count;
    status_t status;
    size_t datalen;
    int *pInts;
   ...
   RIL_onRequestComplete(pRI, RIL_E_SUCCESS, const_cast<int *>(pInts), datalen);
