...
#define KEY_VIDEO_HFR_SIZES "hfr-size-values"
...
static char * camera_fixup_getparams(int id, const char * settings)
{
    ...
    params.set(KEY_VIDEO_HFR_SIZES, "2072x1166,1280x720,1280x720,1280x720");
